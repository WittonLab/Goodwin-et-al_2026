...
The code is provided "as is". It has been specifically formatted for use on multi-image TIFF image files captured using ScanImage software for 2-photon microscopy experiments,
and is likely to need to be formatted to your data.
